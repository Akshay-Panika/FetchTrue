...
import '../../service/bloc/trending_education/trending_education_bloc.dart';
import '../../service/bloc/trending_education/trending_education_event.dart';
import '../../service/bloc/trending_education/trending_education_state.dart';
...
import '../../service/model/trending_education_model.dart';
...
class TrendingEducationServiceWidget extends StatelessWidget {
  const TrendingEducationServiceWidget({super.key});

  @override
  Widget build(BuildContext context) {
    Dimensions dimensions = Dimensions(context);
    return BlocProvider(
      create: (_) => TrendingEducationBloc(TrendingEducationalRepository())..add(GetEducation()),
      child: BlocBuilder<TrendingEducationBloc, TrendingEducationState>(
        builder: (context, state) {
          if (state is TrendingEducationLoading) {
            return _buildShimmer(dimensions);
          } else if (state is TrendingEducationLoaded) {
            ...
            return Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text('Bestseller Educational Courses', style: textStyle12(context),),
                ),
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final TrendingEducationModel franchise = state.educations[index];
          ...
          } else if (state is TrendingEducationError) {
            print(state.message);
            return SizedBox.shrink();
          }
