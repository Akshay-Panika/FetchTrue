...
import '../../service/bloc/trending_marketing/trending_marketing_bloc.dart';
import '../../service/bloc/trending_marketing/trending_marketing_event.dart';
...
class TrendingMarketingServiceWidget extends StatelessWidget {
  const TrendingMarketingServiceWidget({super.key});

  @override
  Widget build(BuildContext context) {
    Dimensions dimensions = Dimensions(context);
    return BlocProvider(
      create: (_) => TrendingMarketingBloc(TrendingMarketingRepository())..add(GetMarketing()),
      child: BlocBuilder<TrendingMarketingBloc, TrendingMarketingState>(
        builder: (context, state) {
          if (state is TrendingMarketingLoading) {
            return _buildShimmer(dimensions);
          } else if (state is TrendingMarketingLoaded) {
            ...
            return Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text('Top Marketing Offers', style: textStyle12(context),),
                ),
                SizedBox(
                  height: dimensions.screenHeight*0.25,
                  child: ListView.builder(
                    scrollDirection: Axis.horizontal,
                    itemCount: state.marketing.length,
                    itemBuilder: (context, index) {
                      final TrendingMarketingModel franchise = state.marketing[index];
          ...
          } else if (state is TrendingMarketingError) {
            print(state.message);
            return SizedBox.shrink();
          }
