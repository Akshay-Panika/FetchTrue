...
class EducationBannerWidget extends StatefulWidget {
  final String moduleId;
  const EducationBannerWidget({super.key, required this.moduleId});

  @override
  State<EducationBannerWidget> createState() => _EducationBannerWidgetState();
}

class _EducationBannerWidgetState extends State<EducationBannerWidget> {
