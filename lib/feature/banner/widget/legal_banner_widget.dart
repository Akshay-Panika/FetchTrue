...
class LegalBannerWidget extends StatefulWidget {
  final String moduleId;
  const LegalBannerWidget({super.key, required this.moduleId});

  @override
  State<LegalBannerWidget> createState() => _LegalBannerWidgetState();
}

class _LegalBannerWidgetState extends State<LegalBannerWidget> {
