...
class OnDemandBannerWidget extends StatefulWidget {
  final String moduleId;
  const OnDemandBannerWidget({super.key, required this.moduleId});

  @override
  State<OnDemandBannerWidget> createState() => _OnDemandBannerWidgetState();
}

class _OnDemandBannerWidgetState extends State<OnDemandBannerWidget> {
                ...
                child: CustomNetworkImage(
                    ...
                    onTap: () {
                      if (banner.selectionType == 'referralUrl') {
                        ...
                        print(banner.subcategory!.category!.name);
                        Navigator.push(
                          context,
                          MaterialPageRoute(
