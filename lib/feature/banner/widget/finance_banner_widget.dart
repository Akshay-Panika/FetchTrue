...
class FinanceBannerWidget extends StatefulWidget {
  final String moduleId;
  const FinanceBannerWidget({super.key, required this.moduleId});

  @override
  State<FinanceBannerWidget> createState() => _FinanceBannerWidgetState();
}

class _FinanceBannerWidgetState extends State<FinanceBannerWidget> {
