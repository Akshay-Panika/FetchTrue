...
class OldHomeBannerWidget extends StatefulWidget {
  const OldHomeBannerWidget({super.key});

  @override
  State<OldHomeBannerWidget> createState() => _OldHomeBannerWidgetState();
}

class _OldHomeBannerWidgetState extends State<OldHomeBannerWidget> {
