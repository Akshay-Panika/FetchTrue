...
class EducationRecommendedServiceWidget extends StatelessWidget {
  final String headline;
  final String moduleIndexId;
  const EducationRecommendedServiceWidget({super.key, required this.headline, required this.moduleIndexId});
