...
class MarketingRecommendedServiceWidget extends StatelessWidget {
  final String headline;
  final String moduleIndexId;
  const MarketingRecommendedServiceWidget({super.key, required this.headline, required this.moduleIndexId});
