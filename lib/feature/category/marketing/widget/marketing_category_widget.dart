...
class MarketingCategoryWidget extends StatelessWidget {
  final String? moduleId;
   MarketingCategoryWidget({super.key, this.moduleId});
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Icons.apps, size: 19, color: Colors.purple),5.width,
                    Text('Category', style: textStyle14(context, color: Colors.purple),),
                    10.width,
