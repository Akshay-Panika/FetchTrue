...
class LegalRecommendedServiceWidget extends StatelessWidget {
  final String headline;
  final String moduleIndexId;
  const LegalRecommendedServiceWidget({super.key, required this.headline, required this.moduleIndexId});
