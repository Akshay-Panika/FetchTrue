...
class BusinessCategoryWidget extends StatelessWidget {
  ...
  BusinessCategoryWidget({super.key, required this.moduleIndexId});
      ...
      child:  BlocBuilder<ModuleCategoryBloc, ModuleCategoryState>(
        builder: (context, state) {
          if (state is ModuleCategoryLoading) {
            ...
            return  Column(
              children: [
                CustomHeadline(headline: 'Service', viewSeeAll: false,),
                SizedBox(
                  height: serviceCount > 6 ? 230 : 115,
                  child: GridView.builder(
                    itemCount:serviceCount,
                    scrollDirection: Axis.horizontal,
                    padding: EdgeInsets.symmetric(horizontal: 10),
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        crossAxisCount: serviceCount > 6  ?2 : 1,
