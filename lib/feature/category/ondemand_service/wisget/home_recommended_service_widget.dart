...
class HomeRecommendedServiceWidget extends StatelessWidget {
  final String headline;
  final String moduleIndexId;
  const HomeRecommendedServiceWidget({super.key, required this.headline, required this.moduleIndexId});
