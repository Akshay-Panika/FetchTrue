...
class OnboardingAllServiceWidget extends StatelessWidget {
  final String headline;
  final String moduleIndexId;
  const OnboardingAllServiceWidget({super.key, required this.headline, required this.moduleIndexId,});
      ...
      child: BlocBuilder<ModuleServiceBloc, ModuleServiceState>(
        builder: (context, state) {
          if (state is ModuleServiceLoading) {
            ...
            final services = state.serviceModel.where((service) =>  service.category.module == moduleIndexId).toList();
