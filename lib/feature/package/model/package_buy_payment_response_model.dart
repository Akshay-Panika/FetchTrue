class PackageBuyPaymentResponseModel {
  final int status;
  ...
  PackageBuyPaymentResponseModel({
  ...
  factory PackageBuyPaymentResponseModel.fromJson(Map<String, dynamic> json) {
    return PackageBuyPaymentResponseModel(
      status: json['status'],
